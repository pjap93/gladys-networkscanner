...
module.exports = function init(){
    ...
    return gladys.param.getValue('NETWORK_SCANNER_FREQUENCY_IN_MINUTE','NETWORK_SCANNER_CHECKUSERPRESENCE_IN_MINUTE')
        .then((networkScannerFrequency, networkScannerCheckUserPresence) => {
